...
if __name__ == '__main__':
    posTxt = '/home/junzheng/work/silasi/pelletData/pos.npy'
    negTxt = '/home/junzheng/work/silasi/pelletData/neg.npy'
    modelWeightPath = "pelletModel/model.h5"
    logsDir = "pelletHistory/log.csv"
    x, y = preprocess(posTxt, negTxt)
    trX, teX, trY, teY = train_test_split(x, y, test_size=0.2, shuffle=True)
    C = CNN(modelWeightPath, logsDir)
    # C.train(trX, trY, teX, teY)


    print (C.predict(teX[0]))
